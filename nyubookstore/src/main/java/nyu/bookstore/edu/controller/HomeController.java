...
import nyu.bookstore.edu.service.*;
import nyu.bookstore.edu.service.impl.UserSecurityService;
import nyu.bookstore.edu.utility.MailConstructor;
import nyu.bookstore.edu.utility.SecurityUtility;
import nyu.bookstore.edu.utility.USConstants;
    ...
    public String productDetail(
        ...
        if (principal != null) {
            ...
            for (CartItem cartItem : cartItemList) {
                if (id == cartItem.getProduct().getId()) alreadyInCart = true;
            }
            ...
            model.addAttribute("qtyList", qtyList);
            model.addAttribute("qty", 1);
            model.addAttribute("alreadyInCart", false);
        }
